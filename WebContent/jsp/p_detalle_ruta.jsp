...
<%
	...
	HashMap total = null;
	   ...
	   ArrayList guias = bitacoras.getdetalle_rutas(bitacora,sucursal,caja);
	   ArrayList totales = bitacoras.get_totales_bitacora(bitacora,sucursal,caja);
	  
	   
	   %>
	   <tr><th colspan="10">Bitacora:&nbsp;&nbsp;&nbsp;<%=bitacora%>&nbsp;&nbsp;&nbsp;<input type="button" id="btnExport" value="Excel" /></th></tr>
	   <tr><th colspan="10">Remolque:&nbsp;&nbsp;&nbsp;<%=caja%>&nbsp;&nbsp;&nbsp; GUIAS EAD&nbsp;&nbsp;&nbsp;<img src="../imagen/ead.png" width="90" height="80" border="0">   </th></tr>
	   <tr>
	   <th>Ruta</th> 
	   <th>Guia </th>
	   <th>Paq</th>
