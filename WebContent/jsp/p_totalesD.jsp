...
<meta http-equiv="refresh" content="70; url=../jsp/p_totalesD.jsp?bitacora=<%=bitacora%>&suc=<%=sucursal%>&ruta=<%=ruta%>&seg=<%=segmento%>&tipo=<%=tipo%>&caja=<%=caja%>&remolque=<%=remolque%>">
...
<div > 
	...
	<form>
		<TABLE cellpadding="0" cellspacing="0" class="detalle_carga">
		<TBODY>
